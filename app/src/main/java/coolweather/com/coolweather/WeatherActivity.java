...
import coolweather.com.coolweather.service.AutoUpdateService;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void requestWeather(String weatherId) {
        String url = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=803e1422fde341729a272ce83150bc13";
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        String carWash = "舒适度：" + weather.suggestion.comfort.info;
        String sport = "舒适度：" + weather.suggestion.comfort.info;
